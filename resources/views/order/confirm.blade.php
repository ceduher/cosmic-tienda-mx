...
@section('content')
    ...
    <main class="w-full mt-16 flex flex-row justify-center" >
        <div class="container lg:px-32 relative w-4/5 lg:w-3/5 xl:w-2/3 mx-0 mt-10 shadow-2xl bg-white rounded " style="height: 560px;"  >
            ...
            <div class="text-black relative flex flex-col items-center">
                ...
                <br>
                <div class="text-gray-500 text-xs w-11/12 py-2 text-center md:text-base">
                    <p><b>{{auth()->user()->name}}</b></p>
                    <p>{{__("Order Confirmed Description")}}</p>
                    <p class="mt-3 mb-3">Si tu pedido fue antes de las 12:00 PM te entregaremos hoy mismo entre las 04:00 PM y 06:00 PM; Si tu pedido fue despues de las 12:00 PM, entregaremos tu pedido al día siguiente entre las 09:00 AM y 12:00 PM.</p>
                </div>
            </div>
            <div class="redirect text-center text-white absolute bottom-0 left-0  py-2 w-full bg-green">
