                                        ...
                                        <ul>
                                            ...
                                            @if($order->payment)
                                                <li class="my-2 flex flex-row justify-between">
                                                    ...
                                                    <div>
                                                        @if($order->payment->method === 'card' || $order->payment->method == "Credit Card (Stripe Gateway)")
                                                            Tarjeta
                                                        @else 
                                            ...
                                            @if ($order->delivery_address_id && $order->deliveryAddress)
                                                <li class="flex flex-row justify-between">
                                                    <div class="text-md py-1 text-sm ">
                                                        <i class="fas fa-home"></i> {{$order->deliveryAddress->address}}
                                                    </div>
                                                </li>
                                            @else
                                                <li class="flex flex-row justify-between">
                                                    <div class="text-md py-1 text-sm text-gray-500 ">
