      ...
      <!--   <div class="container lg:px-32 w-full flex flex-col pt-4 ">
            ...
            <div class="w-full mt-3">
                    <div class="grid gap-5 grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4  -mt-1 ">
                       @forelse ($markets as $market)
                        ...
                        @empty
                         <!-- markets     <div class="text-center font-bold text-3xl col-span-4 h-24 flex flex-row justify-center items-center">
        ...
        <div class="container lg:px-32 w-full flex flex-col pt-4 ">
            ...
            <p class="text-gray-400">
                ...
                @else
                   {{__('Usted está buscando:')}} " {{$search_value}} "
                @endif
            </p>
        </div>
        <section class="container lg:px-32 py-4 w-full flex flex-col lg:flex-row ">
            ...
            <div class="w-full mt-3">
                    ...
                    <div class="cursor-pointer box h-44 w-full flex mb-4" >
...
@section('extraJs')
    <script type="application/javascript">
        function goToProduct(slug){
            ...
            // location.href=window.location.origin+'/producto/'+slug;
        }
