...
Vue.component('cart-list', require('./components/Cart.vue').default);
Vue.component('cart-add', require('./components/Cart-add.vue').default);

Vue.component('gmap-loader', require('./components/order/GoogleMapLoader.vue').default);
Vue.component('order-address', require('./components/order/Address.vue').default);
Vue.component('list-address', require('./components/order/ListAddress.vue').default);

Vue.component('vueper-slides', VueperSlides);
Vue.component('vueper-slide', VueperSlide);

Vue.use(VueGoogleMaps, {load: {key: "AIzaSyCGzRxSkLSadhDpD6o9V_K4Ueryiq1PWg8"}});
